...
# Function Call
python3 ../netconfeval/step_1_function_call.py --n_runs $n_runs --model gpt-4-1106 --policy_types reachability waypoint loadbalancing --batch_size 1 3 11 33
...
python3 ../netconfeval/step_1_function_call.py --n_run $n_runs --model gpt-4-turbo --policy_types reachability waypoint loadbalancing --batch_size 1 3 11 33 --adhoc
python3 ../netconfeval/step_1_function_call.py --n_run $n_runs --model gpt-3.5-turbo --policy_types reachability waypoint loadbalancing --batch_size 1 3 11 33 --adhoc
...
python3 ../netconfeval/step_3_low_level.py --n_run $n_runs --model gpt-4-turbo --mode none
python3 ../netconfeval/step_3_low_level.py --n_run $n_runs --model gpt-4-turbo --mode full
python3 ../netconfeval/step_3_low_level.py --n_run $n_runs --model gpt-4-turbo --mode idx
python3 ../netconfeval/step_3_low_level.py --n_run $n_runs --model gpt-4-turbo --mode rag --rag_chunk_size 9000
